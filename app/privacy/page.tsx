    ...
    <>
      ...
      <div className="p-10">
        ...
        <ul>
          ...
          <li>
            <p>
              <strong>Application</strong> refers to UtilityBar, the software
          ...
          <li>
            <p>
              ...
              "We", "Us" or "Our" in this Agreement) refers to UtilityBar.
            </p>
          </li>
          <li>
            <p>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              <a
                href="https://menu-bar-util-landing-page.vercel.app/"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://menu-bar-util-landing-page.vercel.app/
              </a>
            </p>
          </li>
        </ul>
